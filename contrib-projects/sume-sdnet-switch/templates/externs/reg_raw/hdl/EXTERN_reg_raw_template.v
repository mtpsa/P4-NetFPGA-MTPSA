...
#(
    ...
    parameter INPUT_WIDTH = 2*REG_WIDTH+INDEX_WIDTH+OP_WIDTH+1,
...
/* Tuple format for input: 
        [2*REG_WIDTH+INDEX_WIDTH+8 : 2*REG_WIDTH+INDEX_WIDTH+8] : statefulValid_in
        [2*REG_WIDTH+INDEX_WIDTH+7 : 2*REG_WIDTH+8            ] : index_in
        [2*REG_WIDTH+7             : REG_WIDTH+8              ] : newVal_in
        [REG_WIDTH+7               : 8                        ] : incVal_in
        [7                         : 0                        ] : opCode_in
...
*/
    ...
    (
       // Outputs
       .dout                           ({statefulValid_fifo, index_fifo, newVal_fifo, incVal_fifo, opCode_fifo}),
       .full                           (full_fifo),
       .nearly_full                    (),
       .prog_full                      (),
       .empty                          (empty_fifo),
