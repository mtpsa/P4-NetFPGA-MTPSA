...
create_ip -name nf_sdnet_suIngress -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_suIngress_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_suIngress_ip.xci]
reset_target all [get_ips nf_sdnet_suIngress_ip]
generate_target all [get_ips nf_sdnet_suIngress_ip]

# Superuser Egress Pipeline
create_ip -name nf_sdnet_suEgress -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_suEgress_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_suEgress_ip.xci]
reset_target all [get_ips nf_sdnet_suEgress_ip]
generate_target all [get_ips nf_sdnet_suEgress_ip]

# User 0
create_ip -name nf_sdnet_user0 -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_user0_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_user0_ip.xci]
reset_target all [get_ips nf_sdnet_user0_ip]
generate_target all [get_ips nf_sdnet_user0_ip]

# User 1
create_ip -name nf_sdnet_user1 -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_user1_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_user1_ip.xci]
reset_target all [get_ips nf_sdnet_user1_ip]
generate_target all [get_ips nf_sdnet_user1_ip]

# User 2
create_ip -name nf_sdnet_user2 -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_user2_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_user2_ip.xci]
reset_target all [get_ips nf_sdnet_user2_ip]
generate_target all [get_ips nf_sdnet_user2_ip]

# User 3
create_ip -name nf_sdnet_user3 -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_user3_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_user3_ip.xci]
reset_target all [get_ips nf_sdnet_user3_ip]
generate_target all [get_ips nf_sdnet_user3_ip]

# User 4
create_ip -name nf_sdnet_user4 -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_user4_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_user4_ip.xci]
reset_target all [get_ips nf_sdnet_user4_ip]
generate_target all [get_ips nf_sdnet_user4_ip]

# User 5
create_ip -name nf_sdnet_user5 -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_user5_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_user5_ip.xci]
reset_target all [get_ips nf_sdnet_user5_ip]
generate_target all [get_ips nf_sdnet_user5_ip]

# User 6
create_ip -name nf_sdnet_user6 -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_user6_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_user6_ip.xci]
reset_target all [get_ips nf_sdnet_user6_ip]
generate_target all [get_ips nf_sdnet_user6_ip]

# User 7
create_ip -name nf_sdnet_user7 -vendor NetFPGA -library NetFPGA -module_name nf_sdnet_user7_ip
set_property generate_synth_checkpoint false [get_files nf_sdnet_user7_ip.xci]
reset_target all [get_ips nf_sdnet_user7_ip]
generate_target all [get_ips nf_sdnet_user7_ip]
...
set_property -dict [list \
    ...
    CONFIG.Coe_File {/../../../../../../create_ip/id_rom16x32.coe} \
    CONFIG.Fill_Remaining_Memory_Locations {true} \
    CONFIG.Remaining_Memory_Locations {DEADDEAD} \
...
set_property -dict [list \
    CONFIG.STIM_FILE $::env(NF_DESIGN_DIR)/test/reg_stim.axi \
    CONFIG.EXPECT_FILE $::env(NF_DESIGN_DIR)/test/reg_expect.axi \
    CONFIG.LOG_FILE $::env(NF_DESIGN_DIR)/test/reg_stim.log \
...
#set sdnet_ip_1 top_tb/top_sim/nf_datapath_0/nf_sdnet_suIngress_inst/inst/suIngress_inst/
#add_wave_divider {suIngress SDNet Control Interface}
#add_wave top_tb/top_sim/nf_datapath_0/nf_sdnet_suIngress_inst/inst/internal_rst_done -color yellow
#add_wave $sdnet_ip_1/control_S_AXI_AWADDR
#add_wave $sdnet_ip_1/control_S_AXI_AWVALID
#add_wave $sdnet_ip_1/control_S_AXI_AWREADY
#add_wave $sdnet_ip_1/control_S_AXI_WDATA
#add_wave $sdnet_ip_1/control_S_AXI_WSTRB
#add_wave $sdnet_ip_1/control_S_AXI_WVALID
#add_wave $sdnet_ip_1/control_S_AXI_WREADY
#add_wave $sdnet_ip_1/control_S_AXI_BRESP
#add_wave $sdnet_ip_1/control_S_AXI_BVALID
#add_wave $sdnet_ip_1/control_S_AXI_BREADY
#add_wave $sdnet_ip_1/control_S_AXI_ARADDR
#add_wave $sdnet_ip_1/control_S_AXI_ARVALID
#add_wave $sdnet_ip_1/control_S_AXI_ARREADY
#add_wave $sdnet_ip_1/control_S_AXI_RDATA
#add_wave $sdnet_ip_1/control_S_AXI_RRESP
#add_wave $sdnet_ip_1/control_S_AXI_RVALID
#add_wave $sdnet_ip_1/control_S_AXI_RREADY
#
#set nf_sdnet_1_ip top_tb/top_sim/nf_datapath_0/nf_sdnet_suIngress_inst/inst/
#add_wave_divider {nf_sdnet_suIngress input interface}
#add_wave $nf_sdnet_1_ip/s_axis_tdata -radix hex
#add_wave $nf_sdnet_1_ip/s_axis_tkeep -radix hex
#add_wave $nf_sdnet_1_ip/s_axis_tvalid
#add_wave $nf_sdnet_1_ip/s_axis_tready
#add_wave $nf_sdnet_1_ip/s_axis_tlast
#
#add_wave_divider {nf_sdnet_suIngress output interface}
#add_wave $nf_sdnet_1_ip/m_axis_tdata -radix hex
#add_wave $nf_sdnet_1_ip/m_axis_tkeep -radix hex
#add_wave $nf_sdnet_1_ip/m_axis_tvalid
#add_wave $nf_sdnet_1_ip/m_axis_tready
#add_wave $nf_sdnet_1_ip/m_axis_tlast
