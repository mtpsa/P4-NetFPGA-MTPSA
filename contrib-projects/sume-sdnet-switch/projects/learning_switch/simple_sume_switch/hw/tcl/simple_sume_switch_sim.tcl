...
#set input_arbiter_ip top_tb/top_sim/nf_datapath_0/input_arbiter_v1_0/inst/
...
add_wave $nf_sume_sdnet_ip/in_src_port -radix bin
add_wave $nf_sume_sdnet_ip/in_dst_port -radix bin
...
add_wave $nf_sume_sdnet_ip/out_dst_port -radix bin
