...
#                                "@NUM_CYCLES@" : "max_cycles",
    ...
    "malloc" : {"hdl_template_file": "externs/malloc/hdl/EXTERN_malloc_template.v",
                "cpp_template_file": "externs/malloc/cpp/EXTERN_malloc_template.hpp",
                "replacements": {"@EXTERN_NAME@": "extern_name",
                                 "@MODULE_NAME@": "module_name",
                                 "@PREFIX_NAME@": "prefix_name",
                                 "@BITMASK_WIDTH@": "input_width(memory_bitmask)",
                                 "@PKT_LEN_WIDTH@": "input_width(pkt_len)",
                }
    },
}
